...
export default async function SettingsPage() {
  ...
  if (!settings) return <div className="p-8">Não foi possível carregar as configurações.</div>;
  ...
  return (
    <div className="p-8">
      <header className="mb-6">
        ...
        <h1 className="font-display text-3xl font-bold text-slate-900">Clínica &amp; IA</h1>
